...
This runs Cucumber skeleton using Cucumber's JUnit runner. The `@RunWith(Cucumber.class)` annotation on the `RunCukesTest`
...
The Cucumber runtime parses command line options to know what skeleton to run, where the glue code lives, what plugins to use etc.
